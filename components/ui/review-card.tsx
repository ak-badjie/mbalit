        ...
        >
            ...
            <div className="flex items-start justify-between gap-3">
                ...
                {review.isCollectorReview && (
                    <span className="px-2 py-1 text-[10px] font-medium bg-blue-100  text-blue-600  rounded-full">
                        Collector Review
                    </span>
                )}
            </div>
    ...
    return (
        <div className="flex items-center gap-4 p-4 bg-gradient-to-r from-amber-50 to-orange-50   rounded-2xl">
            ...
            <div className="flex-1">
                <p className="text-sm text-gray-600 ">
                    Based on <span className="font-semibold text-gray-900 ">{totalReviews}</span> reviews
                </p>
